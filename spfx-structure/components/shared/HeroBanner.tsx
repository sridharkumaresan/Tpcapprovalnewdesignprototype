...
import { 
  ...
  TextBulletListSquareCheckmarkRegular,
          ...
          <div className={styles.contentContainer}>
            ...
            <div className={styles.topRow}>
              <div className={styles.widgetPill}>
                <WeatherSnowCloudRegular style={{ color: '#fde047' }} fontSize={24} />
              ...
              <div className={styles.widgetPill}>
                <ArrowTrendingLinesFilled style={{ color: '#4ade80' }} fontSize={24} />
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div className={styles.headerContainer}>
              <div className={styles.headerBox}>
                {displayTimeOfDay === 'morning' && <WeatherSunnyRegular style={{ color: '#FF8C42' }} fontSize={40} />}
                {displayTimeOfDay === 'afternoon' && <WeatherSunnyRegular style={{ color: '#FFD700' }} fontSize={40} />}
                {displayTimeOfDay === 'evening' && <WeatherMoonRegular style={{ color: '#A78BFA' }} fontSize={40} />}
                
                <div style={{ textAlign: 'left' }}>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                    <h1 className={styles.greetingText}>{greeting}, Sabina</h1>
                    <StarRegular fontSize={20} style={{ color: '#FFD700' }} />
                  </div>
            ...
            <div className={styles.actionCardsGrid}>
              ...
              <button className={mergeClasses(styles.actionCard, styles.cardRed)}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      <div style={{ padding: '6px', backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: '8px' }}>
                        <DocumentCheckmarkRegular style={{ color: '#fff' }} fontSize={16} />
                      </div>
                  ...
                  <ChevronRightRegular fontSize={24} style={{ color: 'rgba(255,255,255,0.7)', marginTop: '4px' }} />
                </div>
              </button>
              ...
              <button className={mergeClasses(styles.actionCard, styles.cardOrange)}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      <div style={{ padding: '6px', backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: '8px' }}>
                        <TextBulletListSquareCheckmarkRegular style={{ color: '#fff' }} fontSize={16} />
                      </div>
              ...
              <button className={mergeClasses(styles.actionCard, styles.cardNavy)}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      <div style={{ padding: '6px', backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: '8px' }}>
                        <HatGraduationRegular style={{ color: '#fff' }} fontSize={16} />
                      </div>
        ...
        <div className={styles.scrolledNavbar}>
           ...
           <div style={{ display: 'flex', flexGrow: 1, maxWidth: '600px', gap: '12px', alignItems: 'center' }}>
              <div style={{ flexGrow: 1, position: 'relative' }}>
                 <SearchRegular style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.6)' }} />
